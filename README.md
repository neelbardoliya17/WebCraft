# # WebCraft # #
WebCraft gives streamlines user registration and offers a dynamic dashboard for managing business details and subscriptions. Users can customize themes, personal details, and various content sections, while admins oversee user sites and subscription statuses for seamless management.
# Use CodeIgniter 3.0 (PHP Framework) #
